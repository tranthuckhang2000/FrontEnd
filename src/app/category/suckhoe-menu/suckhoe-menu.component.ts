...
@Component({
  selector: 'app-suckhoe-menu',
  templateUrl: './suckhoe-menu.component.html',
  styleUrls: ['./suckhoe-menu.component.css']
})
export class SuckhoeMenuComponent implements OnInit {
