...
@Component({
  selector: 'app-giaoduc-menu',
  templateUrl: './giaoduc-menu.component.html',
  styleUrls: ['./giaoduc-menu.component.css']
})
export class GiaoducMenuComponent implements OnInit {
